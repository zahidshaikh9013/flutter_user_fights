...
const p14 = EdgeInsets.all(14);
const p16 = EdgeInsets.all(16);
const p18 = EdgeInsets.all(18);
const p20 = EdgeInsets.all(20);
const p30 = EdgeInsets.all(30);

final hp8 = EdgeInsets.symmetric(horizontal: 8.0);
final hp12 = EdgeInsets.symmetric(horizontal: 12.0);
final hp16 = EdgeInsets.symmetric(horizontal: 16.0);
